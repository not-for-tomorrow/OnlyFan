package com.example.onlyfanshop.map.config;
...
public class MapConfig {
    ...
    public static String LOCATION_IQ_API_KEY = "6a63f388fbd716914de899f77dfb04c6";
    ...
    public enum RoutingPrimary { OPENROUTESERVICE, GRAPHHOPPER }
    public enum AutocompletePrimary { GEOAPIFY, LOCATIONIQ }

    public static GeocodingPrimary GEOCODING_PRIMARY = GeocodingPrimary.CHAINED;
    public static RoutingPrimary ROUTING_PRIMARY = RoutingPrimary.OPENROUTESERVICE;
    public static AutocompletePrimary AUTOCOMPLETE_PRIMARY = AutocompletePrimary.GEOAPIFY;
