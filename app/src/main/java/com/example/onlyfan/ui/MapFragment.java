package com.example.onlyfan.ui;
...
import com.example.onlyfan.ViewModel.MapViewModel;
import com.example.onlyfan.map.config.KeyStorage;
import com.example.onlyfan.map.config.MapConfig;
import com.example.onlyfan.map.core.interfaces.MapProvider;
import com.example.onlyfan.map.impl.map.OsmMapProvider;
