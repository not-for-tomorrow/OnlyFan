package com.example.onlyfan.map.core.facade;

import com.example.onlyfan.map.config.MapConfig;
...
import com.example.onlyfan.map.impl.autocomplete.GeoapifyAutocompleteProvider;
import com.example.onlyfan.map.impl.autocomplete.LocationIQAutocompleteProvider;
import com.example.onlyfan.map.impl.geocoding.ChainedGeocodingProvider;
import com.example.onlyfan.map.impl.geocoding.GeoapifyGeocodingProvider;
import com.example.onlyfan.map.impl.geocoding.LocationIQGeocodingProvider;
import com.example.onlyfan.map.impl.geocoding.OpenCageGeocodingProvider;
import com.example.onlyfan.map.impl.routing.GraphHopperRoutingProvider;
import com.example.onlyfan.map.impl.routing.OpenRouteServiceRoutingProvider;
